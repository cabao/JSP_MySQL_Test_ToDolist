...
<%
  ...
  if (p_name != null && p_id != null && p_photo != null && p_description != null){
    database.connectDB();
    database.editData(p_id , p_name, p_description, p_photo);
  }
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <h style="font-size:25px;">ToDo List後台管理</h>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="exampleModalLabel1">新增代辦事項</h4> </div>
                            <div class="modal-body">
                                <form action="new.jsp" method="post">
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    <input type="submit" class="btn btn-primary" value="新增代辦">
                                  </div>
                                </form>
                            </div>
                        </div>
